...
>
  <path
    d="M20 1L3 10V34C3 35.1 3.9 36 5 36H35C36.1 36 37 35.1 37 34V10L20 1Z"
    stroke="currentColor"
    strokeWidth="2"
    strokeLinecap="round"
...
>
  <path
    d="M10 2H30C31.1 2 32 2.9 32 4V36L25 32L20 36L15 32L8 36V4C8 2.9 8.9 2 10 2Z"
    stroke="currentColor"
    strokeWidth="2"
    strokeLinecap="round"
    strokeLinejoin="round"
...
>
  <path
    d="M4 8H36C37.1 8 38 8.9 38 10V30C38 31.1 37.1 32 36 32H4C2.9 32 2 31.1 2 30V10C2 8.9 2.9 8 4 8Z"
    stroke="currentColor"
    strokeWidth="2"
    strokeLinecap="round"
    strokeLinejoin="round"
...
>
  <path
    d="M10 4H30C31.1 4 32 4.9 32 6V34C32 35.1 31.1 36 30 36H10C8.9 36 8 35.1 8 34V6C8 4.9 8.9 4 10 4Z"
    stroke="currentColor"
    strokeWidth="2"
    strokeLinecap="round"
    strokeLinejoin="round"
  ...
  <circle cx="30" cy="10" r="3" stroke="currentColor" strokeWidth="2" />
  ...
  <circle cx="30" cy="30" r="3" stroke="currentColor" strokeWidth="2" />
    ...
    paragraph:
      "Handle transactions in multiple currencies with automated tax calculations, ensuring compliance with global standards.",
  },
  {
    id: 5,
    icon: (
...
>
  ...
  },
  {
    id: 6,
    icon: (
      <svg width="40" height="45" viewBox="0 0 40 45" xmlns="http://www.w3.org/2000/svg" className="fill-current">
  <path
    opacity="0.5"
  ...
  <path d="M18.9474 32.6316C18.9474 35.4705 19.8099 38.0969 21.2941 40.2796C21.7904 41.0094 21.3054 42.1053 20.4229 42.1053H4.21053C1.87368 42.1053 0 40.2316 0 37.8947V4.21053C0 1.89474 1.87368 0 4.21053 0H6.31579H16.8421H29.4737C31.7895 0 33.6842 1.87368 33.6842 4.21053V17.9544C33.6842 18.5032 33.1804 18.9474 32.6316 18.9474C25.0737 18.9474 18.9474 25.0737 18.9474 32.6316Z" />
    ...
    paragraph:
      "Streamlined order fulfillment from picking items to packaging and final shipment, ensuring accuracy and speed.",
  },
  {
    id: 7,
    icon: (
  ...
  <path d="M20 10V5" stroke="blue" stroke-width="2"/>
    ...
    paragraph:
      "End-to-end tracking of shipments, optimized route planning, and real-time status updates for timely deliveries.",
  },
];
