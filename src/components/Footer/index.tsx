          ...
          <div className="-mx-4 flex flex-wrap justify-around">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                <li
                      className="mb-4 cursor-pointer block text-base text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                    >
                      Privacy Policy
                  </li>
                  <li
                      className="mb-4 inline-block text-base text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary cursor-pointer"
                    >
                      Terms of Use
                  </li>
                  <li>
